...
export default function ProblemSolution() {
  return (
    <section id="interest" className="py-16 sm:py-20 lg:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-5 sm:px-6">
        <div className="grid lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-20 items-center">
          <div className="order-2 lg:order-1">
            <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
              <div className="p-6 sm:p-8 bg-[#FDFCFB] rounded-3xl border border-gray-100 shadow-sm">
              ...
              <div className="p-6 sm:p-8 bg-[#FDFCFB] rounded-3xl border border-gray-100 shadow-sm sm:mt-8">
                <Clock className="w-8 h-8 sm:w-10 sm:h-10 text-blue-400 mb-4" />
              ...
              <div className="p-6 sm:p-8 bg-[#FDFCFB] rounded-3xl border border-gray-100 shadow-sm">
                <Sparkles className="w-8 h-8 sm:w-10 sm:h-10 text-yellow-500 mb-4" />
              ...
              <div className="p-6 sm:p-8 bg-[#FDFCFB] rounded-3xl border border-gray-100 shadow-sm sm:mt-8">
                <ShieldCheck className="w-8 h-8 sm:w-10 sm:h-10 text-green-500 mb-4" />
          ...
          <div className="order-1 lg:order-2">
            ...
            <ul className="space-y-3 sm:space-y-4">
              {["Isolamento Termico & Acustico", "Illuminazione LED Integrata", "Arredi su Misura in Cartongesso", "Finiture Lisce come Seta"].map((text, i) => (
                <li key={i} className="flex items-center gap-3 font-bold text-sm sm:text-base text-[#1A1A1A]">
                  <div className="w-6 h-6 rounded-full bg-[#E6C9A8] flex items-center justify-center shrink-0">
